...
const INVENTED_ICON_PATTERNS = [
  ...
  {
    pattern: /from\s+['"]@mui\/icons-material[^'"]*['"]/,
    lib: "@mui/icons-material",
  },
  ...
  {
    pattern: /material-symbols-(outlined|rounded|sharp)/,
    lib: "Material Symbols (CDN)",
  },
];
